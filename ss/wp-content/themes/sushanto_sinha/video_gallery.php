      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="page-title-wrapper">
            <div class="container">
              <h2 class="pull-left title"> <span class="cat-icon">VS </span> Video Story</h2>
              <!-- breadcrumb -->
        ...
        <div class="row">
          <div class="col-sm-9">
            <div class="section-title">
              <h3> <span class="cat-icon">VS</span>Video Story</h3>
            </div> <!-- //section-title -->
            <?php
			...
			<?php
				...
				$vsurlcode = get_post_meta(get_the_ID(), '_url_code_meta_key', true);
			?>
			
				<article class="item leading-item gradient-major">
                    <div class="article-inner">
                      <div class="overlay"></div>
                      <div class="img-wrapper"><img class="img-100p latest-post-image" src="https://img.youtube.com/vi/<?php echo $vsurlcode; ?>/hqdefault.jpg" alt="img"></div>
			...
			?>	
					<div class="col-md-4 col-sm-6">
					   <article class="gradient-color04">
						 <div class="article-inner">
						   <div class="overlay"></div>
						   <div class="img-wrapper"><img class="img-100p latest-post-image" src="https://img.youtube.com/vi/<?php echo $vurlcode; ?>/hqdefault.jpg" alt="img"></div>
						   <div class="post-share-social">
							 <a href="#" class="fa fa-facebook"></a>
							 <a href="#" class="fa fa-twitter"></a>
							 <a href="#" class="fa fa-google-plus"></a>
