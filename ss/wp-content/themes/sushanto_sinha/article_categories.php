<?php
/**
*	Template Name: Article/Write Pages
**/
	get_header();
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="page-title-wrapper">
            <div class="container">
              <h2 class="pull-left title"> <span class="cat-icon">A </span> Article/Write Up</h2>
              <!-- breadcrumb -->
              <ol class="breadcrumb pull-right">
                <li><a href="index.html">Home</a></li>
                <li class="active">Article/Write Up</li>
              </ol> <!-- //breadcrumb -->
            </div> <!-- //container -->
        ...
        <div class="row">
          <div class="col-sm-9">
            <div class="section-title">
              <h3> <span class="cat-icon">A</span>Article/Write Up</h3>
            </div> <!-- //section-title -->
            <?php
			...
			<?php
				...
				$artwimg_id		= get_post_thumbnail_id();
				$artwimg_url 	= wp_get_attachment_image_src($artwimg_id, 'pgallery-slider', true);
			?>
			
				<article class="item leading-item gradient-major">
                    <div class="article-inner">
                      <div class="overlay"></div>
                      <div class="img-wrapper"><img class="img-100p latest-post-image" src="<?php echo $artwimg_url[0]; ?>" alt="img"></div>
			...
			<?php
				...
				$artwimg_id		= get_post_thumbnail_id();
				$artwimg_url 	= wp_get_attachment_image_src($artwimg_id, 'hcat-small-image', true);
