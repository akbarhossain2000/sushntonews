...
abstract class WPVideo_meta_box {
	...
	public static function wpvideo_add_meta_box() {
		...
		add_meta_box(
			'video_meta_id',
			__( 'Add video url code', 'ss_text' ),
			array(__CLASS__, 'wpvideo_html'),
			'video_post',
			'normal',
			'high'
		);
...
?>
		<p>
			...
			<input type="text" name="meta_text" id="meta_text" value="<?php echo esc_attr($wpvideo_stored_meta); ?>" class="regular-text" placeholder="<?php esc_html_e('Code add here!', 'ss_text'); ?>" />
		</p>
